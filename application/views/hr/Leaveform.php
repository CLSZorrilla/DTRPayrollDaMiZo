<?php
	...
	$labels=array('Employee ID:','Full Name','Position', 'Department' ,'Leave Type:','Approval Date:','Note:');
	$dName=array('empID', 'fName' ,'pos' ,'dept' ,'leaveType','appDate','note');
	$dType=array('text','text','dropdown','dropdown','dropdown','date','text');
?>
...
<div class="BodyContainer">
	<div class="BodyContent">
		...
		<?php echo form_open_multipart("leave/updateLeaveCredits", $attributes); ?>
